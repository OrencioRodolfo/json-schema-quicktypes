 ...
 */
export interface SBKEventsTransactionEvent {
    kind: Kind;
    meta: SBKEventsTransactionEventMeta;
    /**
     * Defines the UID for this event
     */
    type: SBKEventsTransactionEventType;
}

export interface SBKEventsTransactionEventMeta {
    origin?: Origin;
    [property: string]: any;
}

export enum SBKEventsTransactionEventType {
