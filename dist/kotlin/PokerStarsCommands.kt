...
//
//   val pokerStarsCommands = PokerStarsCommands.fromJson(jsonString)
...
data class PokerStarsCommands (
    ...
    companion object {
        public fun fromJson(json: String) = klaxon.parse<PokerStarsCommands>(json)
    }
}
...
enum class Type(val value: String) {
    ...
    companion object {
        public fun fromValue(value: String): Type = when (value) {
            "@@pokerstars/navigate" -> PokerstarsNavigate
            else                    -> throw IllegalArgumentException()
        }
    }
}
